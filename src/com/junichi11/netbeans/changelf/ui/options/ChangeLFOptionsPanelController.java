...
@org.openide.util.NbBundle.Messages({"AdvancedOption_DisplayName_ChangeLF=Line Endings", "AdvancedOption_Keywords_ChangeLF=line ending, lf, crlf, cr"})
public final class ChangeLFOptionsPanelController extends OptionsPanelController {
    ...
    private ChangeLFPanel getPanel() {
        if (panel == null) {
            panel = new ChangeLFPanel(this);
        }
        return panel;
    }
